...
const VARIANTS = {
    primary: {
        ...
        active: 'bg-gray-700 hover:bg-gray-600 hover:shadow-md focus:border-gray-700 active:bg-gray-900',
    ...
    danger: {
        ...
        active: 'bg-red-500 hover:bg-red-600 focus:border-red-600 focus:shadow-outline-red',
        disabled: 'bg-red-400',
    },
    secondary: {
        base: 'outline-none focus:outline-none',
        active: 'text-gray-700 bg-white border-gray-700 hover:text-white hover:bg-gray-700 active:bg-white active:text-gray-700',
    },
    invert: {
        base: 'outline-none focus:outline-none',
...
const Button = ({
    ...
    return (
        <button
            type="button"
            className={clsx(
                'relative font-semibold text-sm sm:text-base gap-x-2 inline-flex justify-center items-center border transition duration-300 ',
