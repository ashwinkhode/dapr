...
const Products = ({ products }) => {
    ...
    return (
        <div className="relative mx-auto lg:w-10/12 xl:w-3/4 mb-8 mt-4 overflow-hidden lg:overflow-visible">
            <SEO pageTitle="Products" />
            <div className="flex justify-between items-center sm:-mx-4 z-20 fixed bottom-0 bg-transparent w-[100vw] sm:w-[98vw] lg:w-full lg:mx-0 lg:relative lg:mb-1 lg:shadow-none">
                ...
                <div className="lg:text-right flex flex-1 lg:flex-grow-0 z-20">
                    <Button
                        ...
                        onClick={() => {
                            ...
                            dispatchToShop(
                                handleFilterStatus(shopState.filterStatus),
                            )
                        }}
                    >
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            dispatchToShop(
                                handleSortStatus(shopState.sortStatus),
                            )
                        }}
                    >
                        <BsFilter />
